# Generated by Django 5.0.2 on 2024-04-22 11:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fotografía', models.ImageField(blank=True, null=True, upload_to='assets/imagenes/')),
                ('total_existencia', models.IntegerField()),
                ('estatus', models.CharField(choices=[('Disponible', 'Disponible'), ('Agotado', 'Agotado'), ('Mantenimiento', 'Mantenimiento')], default='Disponible', max_length=100)),
            ],
            options={
                'db_table': 'equipos',
            },
